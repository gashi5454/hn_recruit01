...
class AppliesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        // audio_dataが存在するかチェック
        /*
        if(isset($applies['audio_data'])){
        ...
        */
        ...
        if(isset($request->file('audio_data'))){
        // 音源ファイルの保存場所指定
        $filename = $request->file('audio_data')->getClientOriginalName();
        $applies['audio_data'] = $request->file('audio_data')->storeAs('public/audio_datas', $filename);
