...
class OffersController extends BaseController
{
    ...
    public function search(Request $request)
    {
        ...
        if(isset($offers)){
            ...
            //ソート指定ないときは新着順で表示
            if(is_null($reqs['direction'])){
                $offers = $offers->latest('created_at');
            }
        ...
        if(isset($reqs['direction'])){
            $reqs_direction = $reqs['direction'];
            $ad_sort = $reqs['direction'];
        } else {
            $reqs_direction = "";
        }
        ...
        $createUrl = $currentUrl . '?_token=' . $reqs_token .
        ...
        $sort_url = $createUrl . '&disp_list=' . $reqs_disp_list . '&sort=appear_date&direction=';
        $disp_url = $createUrl . '&sort=appear_date&direction=' . $reqs_direction . '&disp_list=';
        //$dump = var_dump($reqs);
