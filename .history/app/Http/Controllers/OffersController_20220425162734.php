    ...
    public function search(Request $request)
    {
        ...
        elseif(!empty($keyword) && empty($appear_date_start) && empty($appear_date_end) && empty($address) && empty($genre))
        {
            ...
            foreach($wordArraySearched as $value) {
                $query->where('name','like', '%' .$value. '%')->where('title','like', '%' .$value. '%')->where('genre','like', '%' .$value. '%')
                        ->where('appear_date','like', '%' .$value. '%')->where('number_of_bands','like', '%' .$value. '%')->where('place','like', '%' .$value. '%')
                        ->where('tel','like', '%' .$value. '%')->where('other_contact','like', '%' .$value. '%')->where('address','like', '%' .$value. '%')
                        ->where('postal_code','like', '%' .$value. '%')->where('capacity','like', '%' .$value. '%')->where('quota','like', '%' .$value. '%')
                        ->where('requirement','like', '%' .$value. '%');
            }
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('genre','like', '%' .$genre. '%')->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('genre','like', '%' .$genre. '%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('genre','like', '%' .$genre. '%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->where('genre','like', '%' .$genre. '%')->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' . $keyword . '%')->where('address','like', '%' . $address . '%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' . $keyword . '%')->where('genre','like', '%' . $genre . '%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' . $keyword . '%')->where('address','like', '%' . $address . '%')->where('genre','like', '%' . $genre . '%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' . $keyword . '%')->where('address','like', '%' . $address . '%')->where('genre','like', '%' . $genre . '%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->where('genre','like', '%' .$genre. '%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
