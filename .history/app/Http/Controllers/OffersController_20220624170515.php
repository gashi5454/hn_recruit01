...
class OffersController extends BaseController
{
    ...
    public function search(Request $request)
    {
        ...
        {
            foreach($wordArraySearched as $value) {
                $query->where('appear_date','>=', $appear_date_start)->Where('name','like', '%' . self::escapeLike($value) . '%')->orWhere('title','like', '%' . self::escapeLike($value) . '%')->orWhere('genre','like', '%' . self::escapeLike($value) . '%')
