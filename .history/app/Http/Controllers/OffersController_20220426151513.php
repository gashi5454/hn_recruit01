    ...
    public function search(Request $request)
    {
        ...
        elseif(!empty($keyword) && empty($appear_date_start) && empty($appear_date_end) && empty($address) && empty($genre))
        {
            ...
            foreach($wordArraySearched as $value) {
                $query->orWhere('name','like', '%' .$value. '%')->orWhere('title','like', '%' .$value. '%')->orWhere('genre','like', '%' .$value. '%')
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->latest('appear_date')->paginate(2);
        ...
        elseif(!empty($keyword) && !empty($appear_date_start) && empty($appear_date_end) && empty($address) && empty($genre))
        {
            ...
            foreach($wordArraySearched as $value) {
                $query->where('name','like', '%' .$value. '%')->orWhere('title','like', '%' .$value. '%')->orWhere('genre','like', '%' .$value. '%')
                        ->orWhere('number_of_bands','like', '%' .$value. '%')->orWhere('place','like', '%' .$value. '%')
                        ->orWhere('tel','like', '%' .$value. '%')->orWhere('other_contact','like', '%' .$value. '%')->orWhere('address','like', '%' .$value. '%')
                        ->orWhere('postal_code','like', '%' .$value. '%')->orWhere('capacity','like', '%' .$value. '%')->orWhere('quota','like', '%' .$value. '%')
                        ->orWhere('requirement','like', '%' .$value. '%');
            }
        ...
        elseif(!empty($keyword) && empty($appear_date_start) && empty($appear_date_end) && !empty($address) && empty($genre))
        {
            ...
            foreach($wordArraySearched as $value) {
                $query->where('name','like', '%' .$value. '%')->orWhere('title','like', '%' .$value. '%')->orWhere('genre','like', '%' .$value. '%')
                        ->orWhere('appear_date','like', '%' .$value. '%')->orWhere('number_of_bands','like', '%' .$value. '%')
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('genre','like', '%' .$genre. '%')->latest('appear_date')->paginate(2);
        ...
        elseif(!empty($keyword) && !empty($appear_date_start) && empty($appear_date_end) && !empty($address) && empty($genre))
        {
            ...
            foreach($wordArraySearched as $value) {
                $query->where('name','like', '%' .$value. '%')->orWhere('title','like', '%' .$value. '%')->orWhere('genre','like', '%' .$value. '%')
                        ->orWhere('number_of_bands','like', '%' .$value. '%')
                        ->orWhere('tel','like', '%' .$value. '%')->orWhere('other_contact','like', '%' .$value. '%')
                        ->orWhere('postal_code','like', '%' .$value. '%')->orWhere('capacity','like', '%' .$value. '%')->orWhere('quota','like', '%' .$value. '%')
                        ->orWhere('requirement','like', '%' .$value. '%');
            }
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('genre','like', '%' .$genre. '%')->where('appear_date','>=', $appear_date_start)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('genre','like', '%' .$genre. '%')->where('appear_date','<=', $appear_date_end)->latest('appear_date')->paginate(2);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->orWhere('place','like','%'.$address.'%')->where('genre','like', '%' . $genre . '%')->whereBetween('appear_date', [$appear_date_start, $appear_date_end])->latest('appear_date')->paginate(2);
