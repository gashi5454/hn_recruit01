...
class OffersController extends BaseController
{
    ...
    public function search(Request $request)
    {
        ...
        {
            $query = Offer::query();
            $offers = $query->where('appear_date','>=', $appear_date_start)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('appear_date','<=', $appear_date_end)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('appear_date','>=', $appear_date_start)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('appear_date','<=', $appear_date_end)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('genre','like', '%' .$genre. '%')->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->where('appear_date','>=', $appear_date_start)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->where('appear_date','<=', $appear_date_end)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('genre','like', '%' .$genre. '%')->where('appear_date','<=', $appear_date_end)->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->where('genre','like', '%' .$genre. '%')->paginate(20);
