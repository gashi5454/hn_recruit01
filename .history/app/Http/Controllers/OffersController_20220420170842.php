...
class OffersController extends BaseController
{
    ...
    {
        $offers = \App\Models\Offer::latest()->paginate(20);
    ...
    public function search(Request $request)
    {
        ...
        {
            $query = Offer::query();
            $offers = $query->where('address','like', '%' .$address. '%')->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('genre','like', '%' .$genre. '%')->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('*','like', '%' .$keyword. '%')->where('address','like', '%' .$address. '%')->paginate(20);
        ...
        {
            $query = Offer::query();
            $offers = $query->where('appear_date','BETWEEN' .$appear_date_start. 'AND')->paginate(20);
            $message = "「".$keyword . "」と". "「". $genre."」を含む検索が完了しました。";
            return view('search')->with([
                'offers' => $offers,
                'message' => $message,
