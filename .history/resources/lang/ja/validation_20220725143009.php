...
return [
    ...
    'date_equals'          => ':attributeは:dateに等しい日付で入力してください。',
    ...
    'gte'                  => [
        'array'   => ':attributeの項目数は、:value個以上で入力してください。',
        'file'    => ':attributeは、:value KB以上で入力してください。',
    ...
    'lte'                  => [
        'array'   => ':attributeの項目数は、:value個以下で入力してください。',
        'file'    => ':attributeは、:value KB以下で入力してください。',
    ...
    'uuid'                 => ':attributeは、有効なUUIDで入力してください。',
    'custom'               => [
        'attribute-name' => [
