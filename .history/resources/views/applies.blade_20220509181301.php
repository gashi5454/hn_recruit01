            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-center">
                        <div class="mr-4 font-medium text-sm text-gray-700">代表者氏名</div>
                        <div class="inline-block font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" class="ml-4 inline-block" style="width: 70%; height: 36px;" type="text" name="name" />
                        @else
                        <x-jet-input id="name" class="ml-4 inline-block mt-1 w-full" style="width: 70%; height: 36px;" type="text" name="name" />
                        @endauth
