...
<div class="flex h-auto bg-white py-4">
    ...
    {{method_field('post')}}
        <div x-data="{isShow:false}" class="mx-auto w-full max-w-760 border-01 shadow p-1 overflow-hidden">
            <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 flex items-center">
                @isset($keyword)
                ...
                @endisset
                <x-jet-secondary-button class="text-sm ml-4" style="height:38px;" type="button" @click="isShow= !isShow">
                        {{ __('詳細検索') }}
