    ...
    <div class="mt-16 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-8">
            <div class="flex items-center">
                ...
                {{ csrf_field()}}
                {{method_field('post')}}
                    <div class="mt-4 inline-block items-center">
                        <x-jet-label class="justify-start mr-16 w-auto" for="keyword" value="{{ __('フリーワード') }}" />
                        <x-jet-input id="keyword" class="block mt-1 ml-16 w-full" placeholder="キーワードを入力" type="text" name="keyword" />
                    </div>
