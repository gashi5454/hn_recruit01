...
<div class="max-w-5xl m-16 px-6 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-16 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6 line-break">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />出演日</div>
                <div class="mt-1">
                <?php
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />ジャンル</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />会場</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />収容人数</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />ノルマ</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />出演条件</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />募集バンド数</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />住所</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />連絡先</div>
                <div class="mt-1">
                @if(isset($offers->tel))
                    {{ $offers->tel }}
                @else
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />その他連絡先</br>(メール、LINE、Skypeなど)</div>
                <div class="mt-1">
            ...
            <div class="mt-4">
                <x-jet-label for="genre" value="{{ __('ジャンル') }}" />代表者氏名</div>
                <div class="mt-1">
