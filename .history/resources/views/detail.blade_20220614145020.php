...
<div class="max-w-2xl mt-8 mb-16 px-6 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-8">
    <p class="line-break text-xl flex justify-center xs:pt-0 min:pt-0 sm:pt-8 md:pt-8 lg:pt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg dark:text-gray-900">
        {{ $offers->title }}
    </p>
