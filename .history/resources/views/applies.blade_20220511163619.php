                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="other_inst" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acba_type">
                                    <option selected value="">選択</option>
                                    <option value="エレアコ">エレアコ</option>
                                    <option value="アコースティック">アコースティック</option>
                                </select>
