    ...
    <div class="mt-16 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6">
            <div class="flex items-center">
                <x-jet-label class="justify-start w-auto mx-16 mr-8 text-lg" for="keyword" value="{{ __('フリーワード') }}" />
                <div class="m-4 line-break max-w-3xl inline-flex text-gray-600 dark:text-gray-600 text-base">
