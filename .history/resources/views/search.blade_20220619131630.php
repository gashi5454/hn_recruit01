...
<div class="relative flex items-top justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="max-w-screen-xl py-6 mx-auto xs:px-4 min:px-4 sm:px-6 md:px-6 lg:px-6">
        <div class="block max-w-900 w-full bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="flex p-1 text-sm xs:flex-wrap min:flex-wrap sm:flex-wrap md:flex-nowrap lg:flex-nowrap">
                <div class="m-2">
                    ...
                    <x-jet-input id="keyword" class="block mt-1 xs:w-280px min:280px sm:330px md:330px lg:330px" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
                <div class="m-2">
                    <x-jet-label for="keyword" value="{{ __('フリーワード') }}" />
                    <x-jet-input id="keyword" class="block mt-1 xs:w-280px min:280px sm:330px md:330px lg:330px" placeholder="キーワードを入力" type="text" name="keyword" />
