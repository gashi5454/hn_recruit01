        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    <div class="applies-table-title req justify-start font-medium text-sm text-gray-700">代表者氏名</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-2" style="width: 200px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @else
                        <x-jet-input id="name" name="name" class="ml-2" style="width: 300px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @endauth
