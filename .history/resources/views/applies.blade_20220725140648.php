    ...
    <p class="flex justify-center mx-8 py-8 text-lg dark:text-gray-900">
        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
            ...
            <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                ...
                @else
                    <x-jet-input value="{{ old('name'), 1 }}" id="name" name="name" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="text" placeholder="例）山田太郎" autofocus autocomplete="name" />
                @endauth
            </div>
