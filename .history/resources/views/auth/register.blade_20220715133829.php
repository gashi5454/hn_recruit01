...
<div class="mt-10 py-10 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-12 border-01">
        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
                ...
                @if ($errors->any())
                    <div class="font-medium text-red-600 text-center xs:text-xs min:text-xs sm:text-sm md:text-sm lg:text-sm">{{ __('Whoops! Something went wrong.') }}</div>

                    <div class="list-disc list-inside text-red-600 xs:text-xs min:text-xs sm:text-sm md:text-sm lg:text-sm">
                        @foreach ($errors->all() as $error)
                            <div class="flex justify-start flex-wrap">{{ $error }}</div>
                        @endforeach
                    </div>
                @endif
