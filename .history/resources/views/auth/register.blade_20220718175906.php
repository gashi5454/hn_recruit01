...
<div class="mt-10 py-10 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-12 border-01">
        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
                ...
                @if ($errors->any())
                <div class="p-4 border-red mt-8 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <div class="ml-2 font-medium text-red-600 xs:text-xs min:text-xs sm:text-sm md:text-sm lg:text-sm">エラーの内容を確認してください。</div>
