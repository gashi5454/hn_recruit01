    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4 flex">
                ...
                <x-jet-input id="name_bands" class="block mt-1 w-full" style="height: 30px;" type="text" name="name" :value="old('name_bands')" required autofocus autocomplete="name_bands" />

            <div class="mt-4 flex">
                <x-jet-label for="kana" value="{{ __('フリガナ') }}" />
                <x-jet-label style="color: #FF0000;" value="{{ __('（必須）') }}" />
            </div>
                <x-jet-input id="kana_bands" class="block mt-1 w-full" style="height: 30px;" type="text" name="kana_bands" :value="old('kana')" required autofocus autocomplete="kana_bands" />

            <div class="mt-4 flex">
                <x-jet-label for="email" value="{{ __('メールアドレス') }}" />
                <x-jet-label style="color: #FF0000;" value="{{ __('（必須）') }}" />
            </div>
                <x-jet-input id="email" class="block mt-1 w-full" style="height: 30px;" type="email" name="email" :value="old('email')" required autofocus autocomplete="email" />
            ...
            <div class="mt-4">
                ...
                <x-jet-input id="name" class="block mt-1 w-full" style="height: 30px;" type="text" name="name" :value="old('name')" autofocus autocomplete="tel" />
            </div>
