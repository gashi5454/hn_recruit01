...
<div class="mt-10 py-10 mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mt-12 border-01">
        <p class="flex justify-center mx-8 pt-8 text-lg dark:text-gray-900">
            新規アカウント登録
        </p>
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
                ...
                {{ csrf_field()}}
                {{method_field('post')}}
                <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 mt-8 mb-16">エントリー情報</div>
                ...
                <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    ...
                    <x-jet-input value="{{ old('name') }}" id="name" name="name" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="text" placeholder="例）山田太郎" autofocus required autocomplete="name" />
                </div>

                <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <x-jet-label class="req" for="kana" value="{{ __('ふりがな') }}" />
                    <x-jet-input value="{{ old('kana') }}" id="kana" name="kana" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="text" placeholder="例）山田太郎" autofocus required autocomplete="kana" />
                </div>

                <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <x-jet-label class="req" for="email" value="{{ __('メールアドレス') }}" />
                    <x-jet-input value="{{ old('email') }}" id="email" name="email" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="email" autofocus required autocomplete="email" />
                </div>

                <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <x-jet-label class="req" for="password" value="{{ __('パスワード') }}" />
                    <x-jet-input value="{{ old('password') }}" id="password" name="password" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="password" autofocus required autocomplete="new-password" />
                </div>

                <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <x-jet-label class="req" for="password_confirmation" value="{{ __('パスワード確認用') }}" />
                    <x-jet-input value="{{ old('password_confirmation') }}" id="password_confirmation" name="password_confirmation" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="password" autofocus required autocomplete="new-password" />
                </div>
