        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
                ...
                <div x-data="{isShow:false}" class="pt-3">
                    ...
                    <div x-show="isShow" x-cloak>
                        ...
                        <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                            <x-jet-label for="asasa" value="{{ __('電話番号') }}" />
                            <x-jet-input value="{{ old('asasa') }}" id="asasa" name="asasa" class="w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="text" placeholder="例）山田太郎" autofocus autocomplete="asasa" />
                        </div>
