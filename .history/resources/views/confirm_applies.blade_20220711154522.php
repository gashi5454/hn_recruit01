    ...
    <div class="mt-10 py-10 mx-auto">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="p-2 line-break items-center">
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('代表者氏名') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                    @isset($applies['name'])
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('ふりがな') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                    @isset($applies['kana'])
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('バンド/ユニット名') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('フリガナ') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('メールアドレス') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                    @isset($applies['email'])
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('電話番号') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
                    @isset($applies['tel'])
                        {{ old('tel' , $applies['tel']) }}
                    @endisset
                ...
                <div class="flex items-center py-6 xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="border font-medium bg-gray-200 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:35%" for="name" value="{{ __('その他連絡先') }}" />
                    <div class="border xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:65%">
