    ...
    <div class="mt-16 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6">
            <table class="detail-table">
                <div class="detail-table-title bg-gray-100 dark:bg-gray-200">フリーワード</div>
                ...
                <!--<x-jet-label class="bg-gray-100 dark:bg-gray-100 w-full ml-4 mr-16 text-lg" for="keyword" value="{{ __('フリーワード') }}" />
                <div class="mx-6 line-break max-w-xl text-gray-600 dark:text-gray-600 text-base">
                    @if(isset($offers->contents))
                    {{ $offers->contents }}
                    @else
                    null
