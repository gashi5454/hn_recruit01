        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">代表者氏名</div>
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">ふりがな</div>
                    <div class="applies-table-data">
                    @isset($applies['kana'])
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">バンド/ユニット名</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">フリガナ</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">メールアドレス</div>
                    <div class="applies-table-data">
                    @isset($applies['email'])
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">電話番号</div>
                    <div class="applies-table-data">
                    @isset($applies['tel'])
                        {{ old('tel' , $applies['tel']) }}
                    @endisset
                ...
                <div class="applies-table w-full mx-auto" style="max-width:400px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 120px;">その他連絡先</div>
                    <div class="applies-table-data">
