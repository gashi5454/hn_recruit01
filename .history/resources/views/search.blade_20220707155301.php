                ...
                <div class="px-2 py-1 w-full">
                    ...
                    <div class="flex">
                        @isset($appear_date_start)
                            <x-jet-input id="appear_date_start" value="{{ old('appear_date_start', $appear_date_start) }}" class="block mt-1 mr-2 text-xs font-medium w-full max-w-120" type="date" name="appear_date_start" />
                        @else
                            <x-jet-input id="appear_date_start" value="{{ old('appear_date_start') }}" class="block mt-1 mr-2 text-xs font-medium w-full max-w-120" type="date" name="appear_date_start" />
                        @endisset
                        <div class="mt-3">～</div>
                        @isset($appear_date_end)
                            <x-jet-input id="appear_date_end" value="{{ old('appear_date_end', $appear_date_end) }}" class="block mt-1 ml-2 text-xs font-medium w-full max-w-120" type="date" name="appear_date_end" />
                        @else
                            <x-jet-input id="appear_date_end" value="{{ old('appear_date_end') }}" class="block mt-1 ml-2 text-xs font-medium w-full max-w-120" type="date" name="appear_date_end" />
                        @endisset
                    </div>
                </div>
                <div class="px-2 py-1 w-full">
