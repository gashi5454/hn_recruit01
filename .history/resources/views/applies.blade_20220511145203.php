            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->other_contact }}" id="other_contact" name="other_contact" class="ml-2" style="width: 65%; height: 40px;" type="text" placeholder="LINE ID、Skypeなど" />
                        @else
