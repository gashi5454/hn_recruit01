        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->audio_data }}" id="audio_data" name="audio_data" style="width: 370px; height: 36px;" type="file" />
                        @else
                        <x-jet-input id="audio_data" name="audio_data" style="width: 370px; height: 36px;" type="file" />
                        @endauth
                    </div>
                </div>
