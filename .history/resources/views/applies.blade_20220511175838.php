            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        ...
                        @else
                        <x-jet-input id="audio_data" name="audio_data" class="ml-2" style="width: 200px; height: 36px;" type="text" />
                        @endauth
                    </div>
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        ...
                        @else
                        <x-jet-input id="remarks" name="remarks" class="ml-2" style="width: 200px; height: 36px;" type="text" />
                        @endauth
                    </div>
