        ...
        <div class="p-6">
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="vo_num">
                            ...
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="vo_inst" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 40px;" name="vo_inst">
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">エレキギター</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="elgt_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elgt_num">
                                    <option selected value="">0人</option>
                                    ...
                                    <option value="エレキギター5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="elgt_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elgt_mic">
                                    <option selected value="">なし</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">アコースティック<br>ギター</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">タイプ：</div>
                                <select id="acgt_type" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acgt_type">
                            ...
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="acgt_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acgt_num">
                                    <option selected value="">0人</option>
                                    ...
                                    <option value="アコースティックギター5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="acgt_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acgt_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">エレキベース</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="elba_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elba_num">
                                    <option selected value="">0人</option>
                                    ...
                                    <option value="エレキベース5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="elba_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elba_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">アコースティック<br>ベース</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">タイプ：</div>
                                <select id="acba_type" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acba_type">
                                    <option selected value="">選択</option>
                                    <option value="エレアコ">エレアコ</option>
                                    <option value="アコースティック">アコースティック</option>
                                </select>
                            ...
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="acba_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acba_num">
                                    <option selected value="">0人</option>
                                    ...
                                    <option value="アコースティックベース5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="acba_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="acba_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">ドラム</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="dr_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="dr_num">
                                    <option selected value="">0人</option>
                                    <option value="ドラム1人">1人</option>
                                    <option value="ドラム2人">2人</option>
                                    <option value="ドラム3人">3人</option>
                                    <option value="ドラム4人">4人</option>
                                    <option value="ドラム5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="dr_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="dr_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">キーボード</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="key_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="key_num">
                                    <option selected value="">0人</option>
                                    <option value="キーボード1人">1人</option>
                                    <option value="キーボード2人">2人</option>
                                    <option value="キーボード3人">3人</option>
                                    <option value="キーボード4人">4人</option>
                                    <option value="キーボード5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="key_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="key_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title">その他</div>
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                            ...
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="acba_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="other_mic">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
                    ...
                    <div class="mt-8">
                        ...
                        <select id="genre" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="height: 40px;" name="genre">
                            @auth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        <div class="flex">
                            <div class="mr-1 font-medium text-sm text-gray-700">音源</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->audio_data }}" id="audio_data" name="audio_data" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="audio_data" name="audio_data" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @endauth
                    </div>
