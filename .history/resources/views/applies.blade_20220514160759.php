        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                    <select id="audio_select" name="audio_select" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 36px;">
                        <option></option>
                        <option></option>
                    </select>
                        @auth
                        <input value="{{ old('audio_data', Auth::user()->audio_data) }}" id="audio_data" name="audio_data" type="file" />
                        <x-jet-input value="{{ old('audio_url', Auth::user()->audio_url) }}" id="audio_url" name="audio_url" style="width: 370px; height: 36px;" type="text" placeholder="youtubeのURLなど" />
                        @else
