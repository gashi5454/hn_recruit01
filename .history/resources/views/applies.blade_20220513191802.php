        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <textarea id="remarks" name="remarks" rows="10" cols="30" style="height: 100px;" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ Auth::user()->remarks }}</textarea>
                        @else
                        <textarea id="remarks" name="remarks" rows="10" cols="30" style="height: 100px;" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"></textarea>
                        @endauth
                    </div>
                </div>
