                ...
                {{method_field('post')}}
                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end">
                                <div class="mt-1 text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="gt_num" class="mt-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="gt_num">
                                    <option selected value="">0人</option>
                                    <option value="ボーカル1人">1人</option>
                                    <option value="ボーカル2人">2人</option>
                                    <option value="ボーカル3人">3人</option>
                            ...
                            <div class="flex items-center justify-end">
                                ...
                                <select id="gt_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 40px;" name="gt_num">
                                    <option selected value="">なし</option>
