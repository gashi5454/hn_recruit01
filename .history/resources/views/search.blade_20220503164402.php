        ...
        <div class="max-w-6xl mt-10 py-10 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="max-w-3xl my-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
                <div class="p-6 line-break">
                    ...
                    <div class="ml-4">
                        <img src="{{ asset('storage/app/public/icon/icon_genre_16px.png') }}" alt="ジャンル" width="10px" height="10px" class="flex">
                        <div class="flex mt-3 text-gray-900 dark:text-gray-900 text-sm">
                        {{ $offer->genre }}
                        </div>
                    </div>
                    <div class="ml-4">
