    ...
    <head>
        ...
        <script type="text/javascript" defer>
			window.onload = function() {
                ...
                document.getElementById('dataIsOpen_res').style.display="none";
                document.getElementById('urlIsOpen_res').style.display="none";
                document.getElementById('instIsOpen_res').style.display="none";
			}

            function changeInstView() {
				let id = document.getElementById('vo_inst').value;
                let id_res = document.getElementById('vo_inst_res').value;
                ...
                if (id_res=='その他') {
					document.getElementById('instIsOpen_res').style.display="";
				} else {
					document.getElementById('instIsOpen_res').style.display="none";
				}
			}
			...
			function changeAudioView() {
				...
				let id_res = document.getElementById('audio_select_res').value;
                ...
                if (id_res=='data') {
					document.getElementById('dataIsOpen_res').style.display="";
                    document.getElementById('urlIsOpen_res').style.display="none";
				} else if (id_res=='url') {
					document.getElementById('dataIsOpen_res').style.display="none";
                    document.getElementById('urlIsOpen_res').style.display="";
				} else {
					document.getElementById('dataIsOpen_res').style.display="none";
                    document.getElementById('urlIsOpen_res').style.display="none";
				}
