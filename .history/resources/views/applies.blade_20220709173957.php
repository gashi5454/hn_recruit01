...
<div class="mt-10 py-10 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-6">
    ...
    <p class="flex justify-center mx-8 py-8 text-base dark:text-gray-900">
        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
            ...
            <div class="responsive-composition-table-data mx-auto xs:max-w-280 min:max-w-280 sm:max-w-280 md:max-w-450 lg:max-w-450">
                ...
                @auth
                    <div id="instIsOpen"><x-jet-input value="{{ old('vo_inst_other', Auth::user()->vo_inst_other) }}" id="vo_inst_other" name="vo_inst_other" class="my-1 w-full" type="text" /></div>
                @else
                    <div id="instIsOpen"><x-jet-input value="{{ old('vo_inst_other') }}" id="vo_inst_other" name="vo_inst_other" class="my-1 w-full" type="text" /></div>
                @endauth
            ...
            <div class="responsive-composition-table-data xs:mx-auto min:mx-auto sm:mx-16 md:mx-16 lg:mx-16 xs:max-w-280 min:max-w-280 sm:max-w-280 md:max-w-450 lg:max-w-450">
            ...
            <div class="responsive-composition-table-data xs:mx-auto min:mx-auto sm:mx-16 md:mx-16 lg:mx-16 xs:max-w-280 min:max-w-280 sm:max-w-280 md:max-w-450 lg:max-w-450">
                ...
                @auth
                    <x-jet-input id="composition_other" value="{{ old('other_part_num', Auth::user()->other_part_num) }}" class="w-full max-w-450" type="text" name="other_part_num" placeholder="例）DJ：1人、パーカッション：1人" />
                @else
                    <x-jet-input id="composition_other" value="{{ old('other_part_num') }}" class="w-full max-w-450" type="text" name="other_part_num" placeholder="例）DJ：1人、パーカッション：1人" />
                @endauth
                <div class="mt-4 text-gray-900 dark:text-gray-900 text-sm">コーラスマイク本数</div>
            ...
            <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                ...
                @auth
                    ...
                    <div id="urlIsOpen"><x-jet-input value="{{ old('audio_url', Auth::user()->audio_url) }}" id="audio_url" name="audio_url" class="my-1 w-full" type="text" placeholder="youtubeのURLなど" /></div>
                @else
                    ...
                    <div id="urlIsOpen"><x-jet-input value="{{ old('audio_url') }}" id="audio_url" name="audio_url" class="my-1 w-full" type="text" placeholder="youtubeのURLなど" /></div>
                @endauth
            </div>
