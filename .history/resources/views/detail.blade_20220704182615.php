...
<div class="max-w-2xl mt-8 mb-16 px-6 mx-auto xs:px-0 min:px-0 sm:px-2 md:px-4 lg:px-4">
    <p class="px-2 line-break xs:text-lg min:text-lg sm:text-xl md:text-xl lg:text-xl flex justify-center bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg dark:text-gray-900">
