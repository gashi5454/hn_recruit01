...
<div class="relative flex h-auto bg-gray-100 dark:bg-white py-4">
    ...
    {{method_field('post')}}
        <div class="mx-auto w-full bg-white p-1 dark:bg-gray-100 overflow-hidden shadow">
            ...
            <div class="flex items-center xs:flex-wrap min:flex-wrap sm:flex-wrap md:flex-wrap lg:flex-nowrap">
                <div class="px-2 py-2">
                        <a id="ad_asc" class="text-sm underline" href="{{ $ad_sort }}asc">
                            出演日昇順
                            <i class="fa fa-sort"></i>
                        </a>
                </div>
                <div class="px-2 py-2">
                        <a id="ad_desc" class="text-sm underline" href="{{ $ad_sort }}desc">
                            出演日降順
                            <i class="fa fa-sort"></i>
                        </a>
                </div>
                <div class="px-2 py-2">
                    <select id="disp_list" name="disp_list" onchange="queryListed();">
                        <option value="{{ $disp_list }}">選択してください</option>
