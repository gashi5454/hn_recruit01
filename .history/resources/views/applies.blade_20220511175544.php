            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->audio_data }}" id="audio_data" name="audio_data" class="ml-4" style="width: 65%; height: 36px;" type="text" />
                        @else
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->remarks }}" id="remarks" name="remarks" class="ml-4" style="width: 65%; height: 36px;" type="text" />
                        @else
