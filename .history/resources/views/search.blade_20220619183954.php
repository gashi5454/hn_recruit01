<x-app-layout>
<div class="relative flex items-center justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="pt-2 pb-6 mx-auto xs:px-0 min:px-2 sm:px-4 md:px-6 lg:px-6">

    <form action="{{ url('/search')}}" method="get">
    {{ csrf_field()}}
    {{method_field('post')}}
        <div class="w-full bg-white p-1 dark:bg-gray-100 overflow-hidden shadow">
