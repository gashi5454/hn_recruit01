    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">代表者氏名</div>
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">ふりがな</div>
                    <div class="applies-table-data">
                    @isset($applies['kana'])
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">バンド/ユニット名</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">フリガナ</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">メールアドレス</div>
                    <div class="applies-table-data">
                    @isset($applies['email'])
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">電話番号</div>
                    <div class="applies-table-data">
                    @isset($applies['tel'])
                        {{ old('tel' , $applies['tel']) }}
                    @endisset
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">その他連絡先</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">ジャンル</div>
                    <div class="applies-table-data">
                        @isset($applies['genre'])
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">音源</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table w-full mx-auto" style="max-width:330px">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 150px;">備考</div>
                    <div class="applies-table-data">
