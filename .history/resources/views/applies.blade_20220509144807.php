            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="vo_select" type="checkbox" value="ボーカル" name="vo_select" />
                        ボーカル</div>
                        <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_num">
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="gt_select" type="checkbox" value="ギター" name="gt_select" />
                        ギター</div>
                        <select id="gt_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="gt_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="ba_select" type="checkbox" value="ベース" name="ba_select" />
                        ベース</div>
                        <select id="ba_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <x-jet-input id="dr_select" type="checkbox" value="ドラム" name="dr_select" />ドラム
                        <select id="dr_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="dr_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <x-jet-input id="key_select" type="checkbox" value="キーボード" name="key_select" />キーボード
                        <select id="key_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="key_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <x-jet-input id="per_select" type="checkbox" value="パーカッション" name="per_select" />パーカッション
                        <select id="per_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="per_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <x-jet-input id="ba_select" type="checkbox" value="ベース" name="ba_select" />ベース
                        <select id="ba_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
