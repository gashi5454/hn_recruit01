    ...
    <div class="mt-10 py-10 mx-auto">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 mb-16">エントリー情報</div>
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-gray-200 pt-7 text-center xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:30%; height:84px;" for="name" value="{{ __('ボーカル') }}" />
                    <div style="width:70%">
                        ...
                        <div class="pl-2 py-2 border-2d-dotted xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">使用楽器：
