...
<div class="mt-10 py-10 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-6">
    ...
    <p class="flex justify-center mx-8 py-8 text-base dark:text-gray-900">
        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
            ...
            <div class="responsive-composition-table-data xs:mx-auto min:mx-auto sm:mx-16 md:mx-16 lg:mx-16 xs:max-w-280 min:max-w-280">
            ...
            <div class="responsive-composition-table-data xs:mx-auto min:mx-auto sm:mx-16 md:mx-16 lg:mx-16 xs:max-w-280 min:max-w-280 sm:w-full md:w-full lg:w-full">
