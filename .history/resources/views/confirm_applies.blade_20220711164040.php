        ...
        <div class="mt-8 bg-white border-01">
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 mb-16">エントリー情報</div>
                ...
                <div class="responsive-composition-table-data mx-auto xs:max-w-280 min:max-w-280 sm:max-w-450 md:max-w-450 lg:max-w-520">
                    <x-jet-label class="flex justify-center" for="other_contact" value="{{ __('ボーカル') }}" />
                    <div class="flex justify-center mt-4 text-gray-900 dark:text-gray-900 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">
                        人数：{{ old('vo_num' , $applies['vo_num']) }}
                    </div>
                    <div class="flex justify-center mt-4 text-gray-900 dark:text-gray-900 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">使用楽器：
