            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" name="name_bands" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @else
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" name="kana_bands" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @else
                    ...
                    <div class="mt-5 flex items-center justify-evenly">
                        <div class="text-base leading-7 font-semibold">ボーカル</div>
                        <div class="flex items-center">
                            <div class="text-gray-900 dark:text-gray-900 text-sm">人数：</div>
                        ...
                        <div class="flex items-center">
                            <div class="text-gray-900 dark:text-gray-900 text-sm">使用楽器(兼任ボーカルのみ)：</div>
                            <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_inst">
