        ...
        <div class="max-w-900 w-auto bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="p-1 text-sm">
                <div class="m-2 flex items-center">
                    ...
                    <x-jet-input id="keyword" class="justify-end mt-1 mr-2 w-full" style="max-width:550px;" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
                <div class="m-2 flex items-center">
                    <x-jet-label for="appear_date" class="w-auto" value="{{ __('出演日') }}" />
                    <x-jet-input id="appear_date_start" class="justify-end mt-1 mr-2 w-full" style="max-width:550px;" type="date" name="appear_date_start" />
                    <div class="mt-4">～</div>
