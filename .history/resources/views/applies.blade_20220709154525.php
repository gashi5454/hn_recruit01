...
<div class="mt-10 py-10 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-6">
    ...
    <p class="flex justify-center mx-8 py-8 text-base dark:text-gray-900">
        ...
        <div class="p-8 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
            <div class="flex justify-center bg-gray-500 text-white text-base mt-8 mb-16">エントリー情報</div>
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base mt-8 mb-16">バンド/ユニット情報</div>
