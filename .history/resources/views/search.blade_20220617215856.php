...
<div class="relative flex items-top justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="max-w-screen-xl py-6 mx-auto xs:px-4 min:px-4 sm:px-6 md:px-6 lg:px-8">
        <div class="max-w-900 w-auto bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="block p-1 text-sm w-auto">
                <div class="m-1 w-full xs:flex-wrap min:flex-wrap sm:flex-wrap md:inline-block lg:inline-block">
                    <x-jet-label for="keyword" value="{{ __('フリーワード') }}" />
                    <x-jet-input id="keyword" class="mt-1" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
                <div class="m-2 w-full xs:flex-wrap min:flex-wrap sm:flex-wrap md:inline-block lg:inline-block">
                    <x-jet-label for="keyword" value="{{ __('フリーワード') }}" />
                    <x-jet-input id="keyword" class="mt-1" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
            </div>
