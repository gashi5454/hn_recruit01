    ...
    <div class="max-w-7xl mt-10 py-10 mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="p-2 line-break items-center">
                ...
                <div class="flex items-center mt-6 mx-auto xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">
                    <x-jet-label class="ml-16 font-medium" for="name" value="{{ __('代表者氏名') }}" />
                    <div class="ml-8">
                    @isset($applies['name'])
