            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->genre }}" id="genre" name="genre" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="genre" name="genre" class="ml-2" style="width: 50%; height: 36px;" type="text" />
                        @endauth
                    </div>
