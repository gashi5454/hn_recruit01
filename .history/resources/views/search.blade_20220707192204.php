...
<div class="flex h-auto bg-white py-4">
    ...
    {{ csrf_field()}}
    {{method_field('post')}}
        <div class="mx-auto w-full max-w-700 border-01 shadow p-1 overflow-hidden">
                ...
                <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 w-full">
                    ...
                    <div class="flex">
                        @isset($appear_date_start)
                            <x-jet-input id="appear_date_start" value="{{ old('appear_date_start', $appear_date_start) }}" class="block mt-1 mr-2 w-full xs:text-xs xs:max-w-120 min:text-xs min:max-w-120 sm:text-sm sm:max-w-126 md:text-sm md:max-w-126 lg:text-sm lg:max-w-126" type="date" name="appear_date_start" />
                        @else
                            <x-jet-input id="appear_date_start" value="{{ old('appear_date_start') }}" class="block mt-1 mr-2 w-full xs:text-xs xs:max-w-120 min:text-xs min:max-w-120 sm:text-sm sm:max-w-126 md:text-sm md:max-w-126 lg:text-sm lg:max-w-126" type="date" name="appear_date_start" />
                        @endisset
                        <div class="mt-3">～</div>
                        @isset($appear_date_end)
                            <x-jet-input id="appear_date_end" value="{{ old('appear_date_end', $appear_date_end) }}" class="block mt-1 ml-2 w-full xs:text-xs xs:max-w-120 min:text-xs min:max-w-120 sm:text-sm sm:max-w-126 md:text-sm md:max-w-126 lg:text-sm lg:max-w-126" type="date" name="appear_date_end" />
                        @else
                            <x-jet-input id="appear_date_end" value="{{ old('appear_date_end') }}" class="block mt-1 ml-2 w-full xs:text-xs xs:max-w-120 min:text-xs min:max-w-120 sm:text-sm sm:max-w-126 md:text-sm md:max-w-126 lg:text-sm lg:max-w-126" type="date" name="appear_date_end" />
                        @endisset
                    </div>
                </div>
                <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 w-full">
