            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="name" name="name" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="kana" name="kana" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" name="name_bands" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="name_bands" name="name_bands" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" name="kana_bands" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="kana_bands" name="kana_bands" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->email }}" id="email" name="email" class="ml-2" style="width: 60%; height: 36px;" type="email" />
                        @else
                        <x-jet-input id="email" name="email" class="ml-2" style="width: 60%; height: 36px;" type="email" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->tel }}" id="tel" name="tel" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="tel" name="tel" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    </div>

                    <div class="mt-8 flex items-center justify-end">
                        <div class="flex">
                            <div class="mr-1 font-medium text-sm text-gray-700">その他連絡先 （LINE、Skypeなど）</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->other_contact }}" id="other_contact" name="other_contact" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="other_contact" name="other_contact" class="ml-2" style="width: 60%; height: 36px;" type="text" />
                        @endauth
                    </div>
