            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="ml-2 flex items-center justify-between">
                        <div>コーラスマイク本数</div>
                        <select id="ba_num" class="mr-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0本</option>
                            <option value="コーラスマイク1本">1本</option>
                            <option value="コーラスマイク2本">2本</option>
                            <option value="コーラスマイク3本">3本</option>
                            <option value="コーラスマイク4本">4本</option>
                            <option value="コーラスマイク5本">5本</option>
                        </select>
                    </div>
