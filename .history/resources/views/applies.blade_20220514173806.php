            ...
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <select id="audio_select" name="audio_select" class="my-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm focus:outline-none" style="width: 200px; height: 36px;">
                        ...
                        @auth
                        <div x-show="dataSpaceIsOpen()" @click="close()">
                            <input value="{{ old('audio_data', Auth::user()->audio_data) }}" id="audio_data" name="audio_data" class="my-1" type="file" />
                        </div>
                        <div x-show="urlSpaceIsOpen()">
                            <x-jet-input value="{{ old('audio_url', Auth::user()->audio_url) }}" id="audio_url" name="audio_url" class="my-1" style="width: 370px; height: 36px;" type="text" placeholder="youtubeのURLなど" />
                        </div>
                            @else
