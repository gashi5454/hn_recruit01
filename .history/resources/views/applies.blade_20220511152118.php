                ...
                {{method_field('post')}}
                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            ...
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 40px;" name="vo_inst">
                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="elecGt_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elecGt_num">
                                    <option selected value="">0人</option>
                            ...
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="elecGt_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="elecGt_mic">
                                    <option selected value="">なし</option>
                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">人数：</div>
                                <select id="ba_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="ba_num">
                                    <option selected value="">0人</option>
                                    <option value="ベース1人">1人</option>
                                    <option value="ベース2人">2人</option>
                                    <option value="ベース3人">3人</option>
                                    <option value="ベース4人">4人</option>
                                    <option value="ベース5人">5人</option>
                                </select>
                            </div>
                            <div class="flex items-center justify-end my-1">
                                <div class="text-gray-900 dark:text-gray-900 text-base">コーラスマイク本数：</div>
                                <select id="ba_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 40px;" name="ba_num">
                                    <option selected value="">なし</option>
                                    <option value="1本">1本</option>
                                    <option value="2本">2本</option>
                                    <option value="3本">3本</option>
