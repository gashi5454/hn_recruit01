        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <select @click="isOpen = !isOpen" id="audio_select" name="audio_select" class="my-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 36px;">
