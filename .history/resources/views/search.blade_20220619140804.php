        ...
        <div class="max-w-900 w-auto bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="p-1 text-sm">
                <div class="m-2 flex justify-between items-center">
                    ...
                    <x-jet-input id="keyword" class="mt-1 w-full" style="max-width:550px;" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
                <div class="m-2 flex justify-around items-center">
