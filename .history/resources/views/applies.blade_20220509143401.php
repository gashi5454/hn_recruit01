            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 flex items-center">
                        <x-jet-input id="vo_select" type="checkbox" value="ボーカル" name="vo_select" />ボーカル
                        <select id="vo_num" class="block ml-24 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_num">
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <select id="gt_num" class="block ml-16 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="gt_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <select id="ba_num" class="block ml-16 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <select id="dr_num" class="block ml-16 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="dr_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <select id="key_num" class="block ml-16 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="key_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <select id="per_num" class="block ml-16 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="per_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
