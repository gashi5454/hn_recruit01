            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-6">
                        ...
                        <select id="composition_select" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="height: 41px;" name="composition_select">
                            @auth
                        ...
                        <select id="composition" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="height: 41px;" name="composition">
                            <option disabled selected>人数を選択</option>
                    ...
                    <div class="flex items-center justify-center mt-6">
                        <input type="hidden" value="{{ $eventers->email }}" name="eventers_email">
                        <input type="hidden" value="{{ $offers }}" name="offers">
