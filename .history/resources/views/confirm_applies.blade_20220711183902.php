        ...
        <div class="mt-8 bg-white border-01">
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 mb-16">エントリー情報</div>
                ...
                <div class="composition-table">
                    ...
                    <div class="composition-table-data">
                        <div class="flex items-center justify-center my-1">
                            <div class="text-gray-900xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">人数：
                ...
                <div class="composition-table">
                    ...
                    <div class="composition-table-data">
                        <div class="flex items-center justify-center my-1">
                            <div class="text-gray-900xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">人数：</div>
                            {{ old('elba_num' , $applies['elba_num']) }}
                        </div>
                        <div class="flex items-center justify-center my-1">
                            <div class="text-gray-900xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">コーラスマイク本数：
