...
<div class="max-w-6xl mt-10 py-10 mx-auto sm:px-6 lg:px-8">
    <p class="text-2xl flex justify-center pt-8 px-4 sm:pt-0 dark:text-gray-900">
        応募情報を入力してください
    </p>
            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-6 flex">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name_leader" class="block mt-1 w-full" style="height: 32px;" type="text" name="name" />
                        @else
                        <x-jet-input id="name" class="block mt-1 w-full" style="height: 32px;" type="text" name="name" />
                        @endauth
                    ...
                    <div class="mt-6 flex">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" class="block mt-1 w-full" style="height: 32px;" type="text" name="kana" />
                        @else
                        <x-jet-input id="kana" class="block mt-1 w-full" style="height: 32px;" type="text" name="kana" />
                        @endauth
                    ...
                    <div class="mt-6 flex">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" class="block mt-1 w-full" style="height: 32px;" type="text" name="name_bands" />
                        @else
                        <x-jet-input id="name_bands" class="block mt-1 w-full" style="height: 32px;" type="text" name="name_bands" />
                        @endauth
                        <x-jet-input-error for="name" class="mt-2" />
                    ...
                    <div class="mt-6 flex">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" class="block mt-1 w-full" style="height: 32px;" type="text" name="kana_bands" />
                        @else
                        <x-jet-input id="kana_bands" class="block mt-1 w-full" style="height: 32px;" type="text" name="kana_bands" />
                        @endauth
                        <x-jet-input-error for="kana" class="mt-2" />
                    ...
                    <div class="mt-6">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->tel }}" id="tel" class="block mt-1 w-full" style="height: 32px;" type="text" name="tel" />
                        @else
                        <x-jet-input id="tel" class="block mt-1 w-full" style="height: 32px;" type="text" name="tel" />
                        @endauth
                    </div>
                    ...
                    <div class="mt-6 flex">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->email }}" id="email" class="block mt-1 w-full" style="height: 32px;" type="email" name="email" />
                        @else
                        <x-jet-input id="email" class="block mt-1 w-full" style="height: 32px;" type="email" name="email" />
                        @endauth
                    ...
                    <div class="mt-6">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->other_contact }}" id="other_contact" class="block mt-1 w-full" style="height: 32px;" type="text" name="other_contact" />
                        @else
                        <x-jet-input id="other_contact" class="block mt-1 w-full" style="height: 32px;" type="text" name="other_contact" />
                        @endauth
                    </div>
                    ...
                    <div class="mt-5 block items-center justify-between">
                        <div>その他</div>
                        <x-jet-input id="other_contact" class="block mt-1 w-full" style="height: 32px;" type="text" name="com_other" />
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <x-jet-input id="audio_data" class="block mt-1 w-full" style="height: 32px;" type="text" name="audio_data" />
                    </div>

                    <div class="mt-6">
                        <x-jet-label for="remarks" value="{{ __('備考') }}" />
                        <x-jet-input id="remarks" class="block mt-1 w-full" style="height: 32px;" type="text" name="remarks" />
                    </div>
