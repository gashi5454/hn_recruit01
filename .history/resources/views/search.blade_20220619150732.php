        ...
        <div class="w-auto bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="p-1 text-sm">
                <div class="m-2 flex flex-nowrap items-center">
                    <div style="width:80px;"><x-jet-label for="keyword" value="{{ __('フリーワード') }}" /></div>
                    <x-jet-input id="keyword" class="mt-1 w-full" style="max-width:200px;" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
