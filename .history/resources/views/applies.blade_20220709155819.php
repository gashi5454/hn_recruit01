...
<div class="mt-10 py-10 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-6">
    ...
    <p class="flex justify-center mx-8 py-8 text-base dark:text-gray-900">
        ...
        <div class="p-2 xs:w-full min:w-280px sm:w-500px md:w-600px lg:w-700px">
            ...
            <div class="responsive-composition-table-data mx-2">
                ...
                <div class="flex items-center justify-start my-1">
                    @auth
                        <div id="instIsOpen_res"><x-jet-input value="{{ old('vo_inst_other', Auth::user()->vo_inst_other) }}" id="vo_inst_other" name="vo_inst_other" class="my-1" type="text" /></div>
                    @else
                        <div id="instIsOpen_res"><x-jet-input value="{{ old('vo_inst_other') }}" id="vo_inst_other" name="vo_inst_other" class="my-1" type="text" /></div>
                    @endauth
                </div>
            ...
            <div class="mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                ...
                @auth
                    ...
                    <div id="urlIsOpen_res"><x-jet-input value="{{ old('audio_url', Auth::user()->audio_url) }}" id="audio_url" name="audio_url" class="my-1 w-full" type="text" placeholder="youtubeのURLなど" /></div>
                @else
                    ...
                    <div id="urlIsOpen_res"><x-jet-input value="{{ old('audio_url') }}" id="audio_url" name="audio_url" class="my-1 w-full" type="text" placeholder="youtubeのURLなど" /></div>
                @endauth
            </div>
