...
<div class="relative flex items-top justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="max-w-6xl py-10 mx-auto xs:px-4 min:px-4 sm:px-6 md:px-6 lg:px-8">
        <div class="max-w-760 my-4 bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
