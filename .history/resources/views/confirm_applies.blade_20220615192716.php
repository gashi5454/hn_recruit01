    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table ml-8">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 170px;">ふりがな</div>
                    <div class="applies-table-data">
                    @isset($applies['kana'])
                ...
                <div class="applies-table ml-8">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 170px;">メールアドレス</div>
                    <div class="applies-table-data">
                    @isset($applies['email'])
