            ...
            <div class="flex items-center xs:flex-wrap min:flex-wrap sm:flex-wrap md:flex-wrap lg:flex-nowrap">
                <div class="px-2 py-2">
                    <x-jet-button class="text-sm">
                        <a href="http://localhost:8000/search?_token=8nAypZs6eQ6SitATs7I71zaXVqx2dQXDhrNQmfDl&amp;_method=post&amp;sort=appear_date&amp;direction=asc">出演日昇順</a>
                        <i class="fa fa-sort-up"></i>
                    </x-jet-button>
                </div>
                <div class="px-2 py-2">
                    <x-jet-button class="text-sm">
                        <a href="http://localhost:8000/search?_token=8nAypZs6eQ6SitATs7I71zaXVqx2dQXDhrNQmfDl&amp;_method=post&amp;sort=appear_date&amp;direction=desc">出演日降順</a>
                ...
                <div class="px-2 py-2">
                    ...
                    <div style="display:none;">
                        <input type="hidden" name="offersOrigin" value="{{ $offersOrigin }}">
                    </div>
                    @endisset
                </div>
            </div>
