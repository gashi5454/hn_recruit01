...
<div class="relative flex items-top justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="pb-6 mx-auto xs:px-0 min:px-2 sm:px-4 md:px-6 lg:px-6">
        <div class="w-full bg-white p-1 dark:bg-gray-100 overflow-hidden shadow min:rounded-lg flex items-center xs:flex-wrap min:flex-wrap sm:flex-wrap md:flex-nowrap lg:flex-nowrap">
