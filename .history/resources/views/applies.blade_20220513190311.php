    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 170px;">ジャンル</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 170px;">音源</div>
                    <div class="applies-table-data">
                        @auth
                ...
                <div class="applies-table">
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="width: 170px;">備考</div>
                    <div class="applies-table-data">
                        @auth
