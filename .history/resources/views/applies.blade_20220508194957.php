            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="flex">
                        ...
                        <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 20px; height: 30px;" name="vo_num">
