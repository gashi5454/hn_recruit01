        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data" x-data="{ isOpen:false }">
                    <select id="audio_select" name="audio_select" class="my-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 36px;">
                        <option @click="isOpen = !isOpen" value="data">ファイルを送信する</option>
                        <option @click="isOpen = !isOpen" value="url">動画などのURLを送信する</option>
                    </select>
                        <div x-show="isOpen">
                            @auth
