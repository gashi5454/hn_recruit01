                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-between w-full">
                        ...
                        <div class="items-center justify-end">
                            <div class="inline font-medium text-sm text-gray-700" style="width:15%; color: #FF0000;">(必須)</div>
                            <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        </div>
                        @else
                        <x-jet-input id="name" class="ml-6" style="width: 100%; height: 36px;" type="text" name="name" />
                        @endauth
