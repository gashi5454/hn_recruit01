            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center">
                        <div class="inline-block font-medium text-sm text-gray-700">代表者氏名</div>
                        <div class="inline-block font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name_leader" class="inline-block mt-1" style="width: 50px; height: 36px;" type="text" name="name" />
                        @else
