        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    <div class="applies-table-title font-medium text-sm text-gray-700">代表者氏名</div>
                    <div class="applies-table-title font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
