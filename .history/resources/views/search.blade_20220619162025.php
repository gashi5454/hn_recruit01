...
<div class="relative flex items-top justify-center h-auto bg-gray-100 dark:bg-white sm:items-center py-4 sm:pt-0">
    <div class="py-6 mx-auto xs:px-4 min:px-4 sm:px-6 md:px-6 lg:px-6">
        <div class="max-w-800 w-full bg-white p-1 dark:bg-gray-100 overflow-hidden shadow min:rounded-lg  flex items-center xs:flex-wrap min:flex-wrap sm:flex-wrap md:flex-nowrap lg:flex-nowrap">
            <div class="m-2">
