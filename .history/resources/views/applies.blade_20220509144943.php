        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="dr_select" type="checkbox" value="ドラム" name="dr_select" />
                        ドラム</div>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="key_select" type="checkbox" value="キーボード" name="key_select" />
                        キーボード</div>
                    ...
                    <div class="mt-4 flex items-center justify-between">
                        <div class="inline">
                        <x-jet-input id="per_select" type="checkbox" value="パーカッション" name="per_select" />
                        パーカッション</div>
