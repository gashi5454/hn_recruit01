            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="山田太郎" />
                        @else
                        <x-jet-input id="name" name="name" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="山田太郎" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="やまだたろう" />
                        @else
                        <x-jet-input id="kana" name="kana" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="やまだたろう" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @else
                        <x-jet-input id="name_bands" name="name_bands" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="山田太郎band" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        ...
                        @else
                        <x-jet-input id="kana_bands" name="kana_bands" class="ml-2" style="width: 65%; height: 36px;" type="text" placeholder="ヤマダタロウバンド" />
                        @endauth
