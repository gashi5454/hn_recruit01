...
<div class="flex items-top justify-center h-auto bg-white py-4">
    <div class="mt-10 py-10 mx-auto">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="p-2 line-break items-center xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">

                <div class="flex items-center mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8">
                    <x-jet-label class="border font-medium bg-gray-200" style="width:25%" for="name" value="{{ __('代表者氏名') }}" />
