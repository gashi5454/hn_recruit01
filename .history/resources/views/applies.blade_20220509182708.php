            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-6 inline-block" style="width: 70%; height: 36px;" type="text" />
                        @else
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" class="ml-6 inline-block" style="width: 70%; height: 36px;" type="text" />
                        @else
