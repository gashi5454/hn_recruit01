                    ...
                    <div class="composition-table-data">
                        <div class="flex items-center justify-end my-1">
                            ...
                            <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 120px; height: 40px;" name="vo_num">
                                <option value="0人" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '0人' }} >0人</option>
                                <option value="1人" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '1人' }} >1人</option>
                                <option value="2人" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '2人' }} >2人</option>
                                <option value="3人" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '3人' }} >3人</option>
                                <option value="4人" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '4人' }} >4人</option>
                                <option value="5人以上" {{ old('vo_num' , Auth::user()->vo_num) == Auth::user()->vo_num ? 'selected' : '5人以上' }} >5人以上</option>
                            </select>
                        </div>
                        <div class="flex items-center justify-end my-1">
