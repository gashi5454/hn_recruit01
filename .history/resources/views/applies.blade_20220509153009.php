            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>ボーカル</div>
                        <select id="vo_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_num">
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>ギター</div>
                        <select id="gt_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="gt_num">
                            <option selected value="">0人</option>
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>ベース</div>
                        <select id="ba_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>ドラム</div>
                        <select id="dr_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="dr_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>キーボード</div>
                        <select id="key_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="key_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
                        <div>パーカッション</div>
                        <select id="per_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="per_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
                            <option value="2人">2人</option>
                            <option value="3人">3人</option>
                    ...
                    <div class="mt-1 ml-4 flex items-center justify-between">
                        <div>コーラスマイク本数</div>
                        <select id="ba_num" class="mr-4 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="ba_num">
                            <option selected value="">0人</option>
                            <option value="1人">1人</option>
