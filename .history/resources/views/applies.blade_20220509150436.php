        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 ml-2 flex items-center justify-between">
