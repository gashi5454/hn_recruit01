        ...
        <div class="p-2 xs:w-full min:w-305px sm:w-500px md:w-600px lg:w-700px">
            ...
            <div class="responsive-composition-table-data xs:mx-auto min:mx-auto sm:mx-16 md:mx-16 lg:mx-16 xs:max-w-280 min:max-w-280 sm:max-w-280 md:max-w-450 lg:max-w-450">
                ...
                <div class="flex items-center justify-start my-1">
                    @auth
                        <div id="instIsOpen"><x-jet-input value="{{ old('vo_inst_other', Auth::user()->vo_inst_other) }}" id="vo_inst_other" name="vo_inst_other" class="my-1" type="text" /></div>
                    @else
                        <div id="instIsOpen"><x-jet-input value="{{ old('vo_inst_other') }}" id="vo_inst_other" name="vo_inst_other" class="my-1" type="text" /></div>
                    @endauth
                </div>
