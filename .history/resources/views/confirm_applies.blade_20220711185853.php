        ...
        <div class="mt-8 bg-white border-01">
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 mb-16">エントリー情報</div>
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('代表者氏名') }}" />
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('ふりがな') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
                    @isset($applies['kana'])
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('バンド/ユニット名') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('フリガナ') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('メールアドレス') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
                    @isset($applies['email'])
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('電話番号') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
                    @isset($applies['tel'])
                        {{ old('tel' , $applies['tel']) }}
                    @endisset
                ...
                <div class="flex items-center xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16">
                    <x-jet-label class="pl-1 border-2d-dotted font-medium bg-f8 py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:40%" for="name" value="{{ __('その他連絡先') }}" />
                    <div class="pl-1 border-2d-dotted py-2 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" style="width:60%">
