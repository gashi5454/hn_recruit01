    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title req font-medium text-sm text-gray-700">代表者氏名</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @else
                        <x-jet-input id="name" name="name" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @endauth
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title req font-medium text-sm text-gray-700">ふりがな</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" style="width: 370px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @else
                        <x-jet-input id="kana" name="kana" style="width: 370px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @endauth
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title req font-medium text-sm text-gray-700">バンド/ユニット名</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" name="name_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @else
                        <x-jet-input id="name_bands" name="name_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @endauth
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title req font-medium text-sm text-gray-700">フリガナ</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" name="kana_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @else
                        <x-jet-input id="kana_bands" name="kana_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @endauth
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title req font-medium text-sm text-gray-700">メールアドレス</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->email }}" id="email" name="email" style="width: 370px; height: 36px;" type="email" />
                        @else
                        <x-jet-input id="email" name="email" style="width: 370px; height: 36px;" type="email" />
                        @endauth
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title font-medium text-sm text-gray-700">電話番号</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->tel }}" id="tel" name="tel" style="width: 370px; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="tel" name="tel" style="width: 370px; height: 36px;" type="text" />
                        @endauth
                    </div>
                </div>

                <div class="applies-table" style="margin: 25px 0px 25px 50px;">
                    <div class="applies-table-title font-medium text-sm text-gray-700">その他連絡先</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->other_contact }}" id="other_contact" name="other_contact" style="width: 370px; height: 36px;" type="text" placeholder="LINE ID、Skypeなど" />
                        @else
                        <x-jet-input id="other_contact" name="other_contact" style="width: 370px; height: 36px;" type="text" placeholder="LINE ID、Skypeなど" />
                        @endauth
                    </div>
                </div>
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 20px;">
                    <div class="applies-table-title font-medium text-sm text-gray-700">ジャンル</div>
                    <div class="applies-table-data">
                ...
                <div class="applies-table" style="margin: 25px 0px 25px 20px;">
                    <div class="applies-table-title font-medium text-sm text-gray-700">音源</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->audio_data }}" id="audio_data" name="audio_data" style="width: 370px; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="audio_data" name="audio_data" style="width: 370px; height: 36px;" type="text" />
                        @endauth
                    </div>
                </div>

                <div class="applies-table" style="margin: 25px 0px 25px 20px;">
                    <div class="applies-table-title font-medium text-sm text-gray-700">備考</div>
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->remarks }}" id="remarks" name="remarks" style="width: 370px; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="remarks" name="remarks" style="width: 370px; height: 36px;" type="text" />
                        @endauth
                    </div>
                </div>
