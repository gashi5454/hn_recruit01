                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            ...
                            <div class="flex items-center justify-end">
                                ...
                                <select id="gt_mic" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="gt_num">
                                    <option selected value="">なし</option>
