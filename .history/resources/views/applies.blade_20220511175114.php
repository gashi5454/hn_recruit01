            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 flex items-center justify-start">
                        <div>
                            <div class="mr-1 mx-4 font-medium text-sm text-gray-700">ジャンル</div>
                        </div>
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        <div>
                            <div class="mr-1 mx-4 font-medium text-sm text-gray-700">音源</div>
                        </div>
                        @auth
                    ...
                    <div class="mt-8 flex items-center justify-start">
                        <div>
                            <div class="mr-1 mx-4 font-medium text-sm text-gray-700">備考</div>
                        </div>
                        @auth
