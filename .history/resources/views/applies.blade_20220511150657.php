                    ...
                    <div class="applies-table">
                        ...
                        <div class="applies-table-data">
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 100px; height: 36px;" name="vo_num">
                            ...
                            <div class="flex items-center justify-end my-1">
                                ...
                                <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 200px; height: 36px;" name="vo_inst">
