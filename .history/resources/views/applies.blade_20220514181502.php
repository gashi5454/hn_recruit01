    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-6">
            <div class="items-center">
                <form action="{{ url('/mail_offers')}}" method="post">
                {{ csrf_field()}}
                {{method_field('post')}}
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('name', Auth::user()->name) }}" id="name" name="name" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @else
                        <x-jet-input value="{{ old('name') }}" id="name" name="name" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @endauth
                        <x-jet-input-error for="name" class="mt-2" required/>
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('kana', Auth::user()->kana) }}" id="kana" name="kana" style="width: 370px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @else
                        <x-jet-input value="{{ old('kana') }}" id="kana" name="kana" style="width: 370px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @endauth
                        <x-jet-input-error for="kana" class="mt-2" required/>
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('name_bands', Auth::user()->name_bands) }}" id="name_bands" name="name_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @else
                        <x-jet-input value="{{ old('name_bands') }}" id="name_bands" name="name_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @endauth
                        <x-jet-input-error for="name_bands" class="mt-2" required/>
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('kana_bands', Auth::user()->kana_bands) }}" id="kana_bands" name="kana_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @else
                        <x-jet-input value="{{ old('kana_bands') }}" id="kana_bands" name="kana_bands" style="width: 370px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @endauth
                        <x-jet-input-error for="kana_bands" class="mt-2" required/>
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('email', Auth::user()->email) }}" id="email" name="email" style="width: 370px; height: 36px;" type="email" />
                        @else
                        <x-jet-input value="{{ old('email') }}" id="email" name="email" style="width: 370px; height: 36px;" type="email" />
                        @endauth
                        <x-jet-input-error for="email" class="mt-2" required/>
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('tel', Auth::user()->tel) }}" id="tel" name="tel" style="width: 370px; height: 36px;" type="text" />
                        @else
                        <x-jet-input value="{{ old('tel') }}" id="tel" name="tel" style="width: 370px; height: 36px;" type="text" />
                        @endauth
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ old('other_contact', Auth::user()->other_contact) }}" id="other_contact" name="other_contact" style="width: 370px; height: 36px;" type="text" placeholder="LINE ID、Skypeなど" />
                        @else
                        <x-jet-input value="{{ old('other_contact') }}" id="other_contact" name="other_contact" style="width: 370px; height: 36px;" type="text" placeholder="LINE ID、Skypeなど" />
                        @endauth
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        <select id="genre" name="genre" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 370px; height: 36px;">
                            @auth
                            <option selected value="{{ old('genre', Auth::user()->genre) }}">{{ Auth::user()->genre }}</option>
                            @else
                            <option selected value="{{ old('genre', '') }}">{{ old('genre', '選択') }}</option>
                            @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data" x-data="dropdown()">
                    <select id="audio_select" name="audio_select" class="my-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm focus:outline-none" style="width: 200px; height: 36px;">
                        <option value="">選択</option>
                        <option @click="openDataSpace()" value="data">ファイルを送信する</option>
                        <option @click="openUrlSpace()" value="url">動画などのURLを送信する</option>
                    </select>
                        @auth
                        <div x-data="{isDataSpace: false}">
                            <input x-show="isDataSpace" value="{{ old('audio_data', Auth::user()->audio_data) }}" id="audio_data" name="audio_data" class="my-1" type="file" />
                        </div>
                        <div x-data="{isUrlSpace: false}">
                            <x-jet-input x-show="isUrlSpace" value="{{ old('audio_url', Auth::user()->audio_url) }}" id="audio_url" name="audio_url" class="my-1" style="width: 370px; height: 36px;" type="text" placeholder="youtubeのURLなど" />
                        </div>
                            @else
                            <input value="{{ old('audio_data') }}" id="audio_data" name="audio_data" type="file" />
                            <x-jet-input value="{{ old('audio_url') }}" id="audio_url" name="audio_url" style="width: 370px; height: 36px;" type="text" placeholder="youtubeのURLなど" />
                        @endauth
                    </div>
                </div>
