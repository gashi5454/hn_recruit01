...
<div class="max-w-5xl mt-10 py-10 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-6">
    ...
    <div class="mt-8 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        ...
        <div class="flex justify-center text-center">
                <div class="bg-blue-400 text-white text-base w-full max-w-360 mb-6">エントリー情報</div>
            </div>
            ...
            @if ($errors->any())
                ...
                <ul class="mt-3 ml-48 list-disc list-inside text-sm text-red-600">
            ...
            <div class="flex justify-center text-center">
                <div class="bg-gray-500 text-white text-base mt-16 mb-12 w-full max-w-360">バンド/ユニット情報</div>
            </div>
        ...
        <div class="p-2 xs:block min:block sm:hidden md:hidden lg:hidden">
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('name', Auth::user()->name) }}" id="name" name="name" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）山田太郎" autofocus autocomplete="name" />
                @else
                    <x-jet-input value="{{ old('name') }}" id="name" name="name" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）山田太郎" autofocus autocomplete="name" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('kana', Auth::user()->kana) }}" id="kana" name="kana" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）やまだたろう" autofocus autocomplete="kana" />
                @else
                    <x-jet-input value="{{ old('kana') }}" id="kana" name="kana" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）やまだたろう" autofocus autocomplete="kana" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('name_bands', Auth::user()->name_bands) }}" id="name_bands" name="name_bands" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）山田太郎band" autofocus autocomplete="name_bands" />
                @else
                    <x-jet-input value="{{ old('name_bands') }}" id="name_bands" name="name_bands" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）山田太郎band" autofocus autocomplete="name_bands" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('kana_bands', Auth::user()->kana_bands) }}" id="kana_bands" name="kana_bands" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）ヤマダタロウバンド" autofocus autocomplete="kana_bands" />
                @else
                    <x-jet-input value="{{ old('kana_bands') }}" id="kana_bands" name="kana_bands" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）ヤマダタロウバンド" autofocus autocomplete="kana_bands" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('email', Auth::user()->email) }}" id="email" name="email" style="height: 36px; max-width:290px;" class="w-full text-sm" type="email" autofocus autocomplete="email" />
                @else
                    <x-jet-input value="{{ old('email') }}" id="email" name="email" style="height: 36px; max-width:290px;" class="w-full text-sm" type="email" autofocus autocomplete="email" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('tel', Auth::user()->tel) }}" id="tel" name="tel" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" autofocus autocomplete="tel" />
                @else
                    <x-jet-input value="{{ old('tel') }}" id="tel" name="tel" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" autofocus autocomplete="tel" />
                @endauth
            </div>
            ...
            <div class="mt-6 mx-2">
                ...
                @auth
                    <x-jet-input value="{{ old('other_contact', Auth::user()->other_contact) }}" id="other_contact" name="other_contact" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）LINE IDなど" autofocus autocomplete="other_contact" />
                @else
                    <x-jet-input value="{{ old('other_contact') }}" id="other_contact" name="other_contact" style="height: 36px; max-width:290px;" class="w-full text-sm" type="text" placeholder="例）LINE IDなど" autofocus autocomplete="other_contact" />
                @endauth
            </div>
