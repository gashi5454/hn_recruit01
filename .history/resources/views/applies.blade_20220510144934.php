            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="applies-table">
                        <div class="applies-table-title" style="width:100px; height:40px;">ボーカル</div>
                        <div class="applies-table-data" style="width:200px; height:40px;">
                            ...
                            <div class="flex items-center" style="width:200px; height:40px;">
                                <div class="inline-block text-gray-900 dark:text-gray-900 text-base">使用楽器(兼任ボーカルのみ)：</div>
                                <select id="vo_num" class="inline border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_inst">
