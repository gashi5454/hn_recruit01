...
<div class="max-w-2xl mt-8 mb-16 px-6 mx-auto xs:px-0 min:px-0 sm:px-2 md:px-4 lg:px-4">
    ...
    @if(isset($offers->detail_photo))
        <img class="max-w-700 w-full max-h-430 h-full" src="{{ asset($offers->detail_photo) }}" alt="image">
    @else
        <img class="max-w-700 w-full max-h-430 h-full" src="{{ asset('storage/datail-photos/default.jpg') }}" alt="image">
    @endif
    </div>
