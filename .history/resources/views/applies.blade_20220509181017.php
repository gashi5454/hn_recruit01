...
<div class="max-w-7xl mt-10 py-10 mx-auto sm:px-6 lg:px-8">
    <p class="text-2xl flex justify-center mx-4 pt-8 px-32 sm:pt-0 dark:text-gray-900">
        応募情報を入力してください
    </p>
            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-center">
                        ...
                        <div class="ml-2 mr-4 inline-block font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" class="inline-block" style="width: 80%; height: 36px;" type="text" name="name" />
                        @else
                        <x-jet-input id="name" class="inline-block mt-1 w-full" style="height: 36px;" type="text" name="name" />
                        @endauth
