...
<div class="max-w-2xl mt-8 mb-16 px-6 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-8">
    <p class="line-break xs:text-lg min:text-lg sm:text-xl md:text-xl lg:text-xl flex justify-center bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg dark:text-gray-900">
        {{ $offers->title }}
    </p>

    <div class="mt-16 flex justify-center">
    @if(isset($offers->detail_photo))
        <img style="width:auto; height:auto; max-width:700px; max-height:500px;" src="{{ asset($offers->detail_photo) }}" alt="image">
    @else
        <img style="width:auto; height:auto; max-width:700px; max-height:500px;" src="{{ asset('storage/datail-photos/default.jpg') }}" alt="image">
    @endif
    </div>
    ...
    <div class="mt-16 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div class="p-8 line-break">
            ...
            <div class="flex justify-center bg-blue-400 text-white text-base">募集情報</div>
            ...
            <div class="flex justify-center bg-gray-500 text-white text-base mt-16">会場情報</div>
            ...
            <div class="mt-8">
                <div class="flex">
                    ...
                    <div class="ml-1 text-gray-600 dark:text-gray-400 text-sm">(メールアドレス、LINE IDなど)</div>
                </div>
                <div class="mt-1 text-sm">
