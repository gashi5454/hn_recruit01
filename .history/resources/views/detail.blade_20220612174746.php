...
<div class="max-w-2xl m-16 px-6 mx-auto min:px-4 sm:px-4 md:px-6 lg:px-8">
    ...
    @if(isset($offers->detail_photo))
        <img style="width:auto; max-width:80%; height:auto; max-height:80%;" src="{{ asset($offers->detail_photo) }}" alt="image">
    @else
        <img style="width:auto; max-width:80%; height:auto; max-height:80%;" src="{{ asset('storage/datail-photos/default.jpg') }}" alt="image">
    @endif
    </div>
