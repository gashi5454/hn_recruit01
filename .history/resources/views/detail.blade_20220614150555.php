...
<div class="max-w-2xl mt-8 mb-16 px-6 mx-auto xs:px-0 min:px-0 sm:px-4 md:px-6 lg:px-8">
    ...
    @if(isset($offers->detail_photo))
        <img style="width:95%; height:95%;" src="{{ asset($offers->detail_photo) }}" alt="image">
    @else
        <img style="width:95%; height:95%;" src="{{ asset('storage/datail-photos/default.jpg') }}" alt="image">
    @endif
    </div>
