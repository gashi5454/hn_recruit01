...
<div class="flex h-auto bg-white py-4">
    ...
    {{method_field('post')}}
        <div x-data="{isShow:false}" class="mx-auto w-full max-w-760 border-01 shadow p-1 overflow-hidden">
            <x-jet-label class="inline xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 mt-2" for="keyword" value="{{ __('フリーワード') }}" />
            ...
            <div x-show="isShow" class="flex items-center flex-wrap" x-cloak>
                <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 w-full">
                    <x-jet-label class="inline" for="appear_date" value="{{ __('出演日') }}" />
                    <div class="flex">
                ...
                <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 w-full">
                    <x-jet-label class="inline" for="address" value="{{ __('都道府県') }}" />
                ...
                <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2 w-full">
                    <x-jet-label class="inline" for="genre" value="{{ __('ジャンル') }}" />
        ...
        <div class="w-full max-w-700 p-2 mb-8 bg-white border-01 shadow overflow-hidden">
