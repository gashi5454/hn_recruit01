                    ...
                    <div class="composition-table-data">
                        <div class="flex items-center justify-end my-1">
                            ...
                            <select id="vo_num" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 120px; height: 40px;" name="vo_num">
                                <option value="0人" @if(old('vo_num') === "0人") selected @elseif("Auth::user()->vo_num" === "0人") selected @endif >0人</option>
                                <option value="1人" @if(old('vo_num') === "1人") selected @elseif("Auth::user()->vo_num" === "1人") selected @endif >1人</option>
                                <option value="2人" @if(old('vo_num') === "2人") selected @elseif("Auth::user()->vo_num" === "2人") selected @endif >2人</option>
                                <option value="3人" @if(old('vo_num') === "3人") selected @elseif("Auth::user()->vo_num" === "3人") selected @endif >3人</option>
                                <option value="4人" @if(old('vo_num') === "4人") selected @elseif("Auth::user()->vo_num" === "4人") selected @endif >4人</option>
                                <option value="5人以上" @if(old('vo_num') === "5人以上") selected @elseif("Auth::user()->vo_num" === "5人以上") selected @endif >5人以上</option>
                            </select>
                        </div>
                        <div class="flex items-center justify-end my-1">
