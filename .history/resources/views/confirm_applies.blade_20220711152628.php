    ...
    <div class="mt-10 py-10 mx-auto">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="p-2 line-break items-center">
                ...
                <div class="flex items-center mt-6 xs:mx-2 min:mx-2 sm:mx-8 md:mx-8 lg:mx-8 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">
                    <x-jet-label class="border font-medium bg-gray-200" style="width:25%" for="name" value="{{ __('代表者氏名') }}" />
                    <div class="border ml-8" style="width:50%">
                    @isset($applies['name'])
