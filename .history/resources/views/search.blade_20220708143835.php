...
<div class="flex h-auto bg-white py-4">
    ...
    {{method_field('post')}}
        ...
        <div class="flex items-center justify-around mt-4">
            ...
            <div class="xs:px-2 min:px-2 sm:px-6 md:px-6 lg:px-6 py-2">
                <select id="ad_sort" name="ad_sort" onchange="changeSortView();" class="xs:text-sm min:text-sm sm:text-base mt-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                    <option value="">日程でソート</option>
                    <option value="{{ $ad_sort }}asc">出演日昇順</option>
                    <option value="{{ $ad_sort }}desc">出演日降順</option>
                </select>
            </div>
            <!--
