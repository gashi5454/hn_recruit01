            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-6">
                        ...
                        <select id="composition" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="height: 40px;" name="composition">
                            @auth
                            <option selected value="{{ Auth::user()->composition }}">{{ Auth::user()->composition }}</option>
                            @else
                            <option selected value="">選択</option>
                            @endauth
                            <option selected value="">洗濯</option>
                        </select>
                    </div>
