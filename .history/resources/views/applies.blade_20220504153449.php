            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    <div class="mt-4">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name_leader" class="block mt-1 w-full" type="text" name="name_leader" />
                        @else
                        <x-jet-input id="name_leader" class="block mt-1 w-full" type="text" name="name_leader" />
                        @endauth
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="name_bands" class="block mt-1 w-full" type="text" name="name_bands" />
                        <x-jet-input-error for="name" class="mt-2" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->tel }}" id="tel" class="block mt-1 w-full" type="text" name="tel" />
                        @else
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="audio_data" class="block mt-1 w-full" type="text" name="audio_data" />
