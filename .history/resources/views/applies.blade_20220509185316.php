            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700" style="width: 10%;">代表者氏名</div>
                            <div class="font-medium text-sm text-gray-700" style="width:10%; color: #FF0000;">(必須)</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="name" class="ml-6" style="width: 70%; height: 36px;" type="text" name="name" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700">フリガナ</div>
                            <div class="font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="kana" name="kana" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700">バンド/ユニット名</div>
                            <div class="font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" name="name_bands" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="name_bands" name="name_bands" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" name="kana_bands" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="kana_bands" name="kana_bands" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700">電話番号</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->tel }}" id="tel" name="tel" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="tel" name="tel" class="ml-6" style="width: 70%; height: 36px;" type="text" />
                        @endauth
                    </div>

                    <div class="mt-8 flex items-center justify-between">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700">メールアドレス</div>
                            <div class="font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->email }}" id="email" name="email" class="ml-6" style="width: 70%; height: 36px;" type="email" />
                        @else
                        <x-jet-input id="email" name="email" class="ml-6" style="width: 70%; height: 36px;" type="email" />
                        @endauth
                    ...
                    <div class="mt-1 flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="flex items-center">人数</div>
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center">使用楽器(兼任ボーカルのみ)</div>
                            <select id="vo_num" class="mr-2 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_num">
