        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        <select id="genre" name="genre" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 370px; height: 36px;">
                            ...
                            @else
                                @if(old('genre'))
                            <option selected value="{{ old('genre') }}">{{ old('genre') }}</option>
                                @else
                            <option selected value="">選択</option>
                                @endif
                            @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <input value="{{ old('audio_data', Auth::user()->audio_data) }}" id="audio_data" name="audio_data" type="file" />
                        @else
                            @if(old('audio_data'))
                        <input value="{{ old('audio_data') }}" id="audio_data" name="audio_data" type="file" />
                            @else
                        <input id="audio_data" name="audio_data" type="file" />
                        @endauth
                    </div>
                </div>
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <textarea value="{{ Auth::user()->remarks }}" id="remarks" name="remarks" rows="10" cols="40" style="height: 130px;" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">{{ Auth::user()->remarks }}</textarea>
                        @else
                        <textarea id="remarks" name="remarks" rows="10" cols="40" style="height: 130px;" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"></textarea>
                        @endauth
                    </div>
                </div>
