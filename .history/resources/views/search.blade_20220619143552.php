        ...
        <div class="max-w-900 w-auto bg-white dark:bg-gray-100 overflow-hidden shadow min:rounded-lg">
            <div class="p-1 text-sm">
                <div class="m-2 flex items-center">
                    <div style="width:80px;"><x-jet-label for="keyword" class="w-auto" value="{{ __('フリーワード') }}" /></div>
                    <x-jet-input id="keyword" class="mt-1 w-full" placeholder="キーワードを入力" type="text" name="keyword" />
                </div>
                <div class="m-2 flex items-center">
                    <x-jet-label for="appear_date" class="w-auto" value="{{ __('出演日') }}" />
                ...
                <div class="m-2 flex items-center">
                    <x-jet-label for="keyword" class="w-auto" value="{{ __('フリーワード') }}" />
