            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" class="ml-6 inline-block" style="width: 70%; height: 36px;" type="text" name="name" />
                        @else
                        <x-jet-input id="name" class="ml-6 inline-block mt-1 w-full" style="width: 70%; height: 36px;" type="text" name="name" />
                        @endauth
                    ...
                    <div class="mt-8 flex items-center justify-center">
                        ...
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" class="ml-6 inline-block" style="width: 70%; height: 36px;" type="text" name="kana" />
                        @else
                        <x-jet-input id="kana" class="ml-6 inline-block mt-1 w-full" style="width: 70%; height: 36px;" type="text" name="kana" />
                        @endauth
