        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->remarks }}" id="remarks" name="remarks" style="width: 370px; height: 200px;" type="text" />
                        @else
                        <x-jet-input id="remarks" name="remarks" style="width: 370px; height: 200px;" type="text" />
                        @endauth
                    </div>
                </div>
