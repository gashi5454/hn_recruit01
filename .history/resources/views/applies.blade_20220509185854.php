            ...
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-8 flex items-center justify-end">
                        <div class="flex">
                            <div class="mr-2 font-medium text-sm text-gray-700">代表者氏名</div>
                            <div class="inline-block ml-2 font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" class="ml-2" style="width: 70%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="name" class="ml-2" style="width: 70%; height: 36px;" type="text" name="name" />
                        @endauth
