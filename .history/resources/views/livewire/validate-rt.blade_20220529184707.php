...
<div class="max-w-7xl py-10 mx-auto sm:px-6 lg:px-8">
    ...
    <x-jet-form-section submit="updateProfileInformation"></x-jet-form-section>

    <div class="mt-6 bg-white dark:bg-gray-100 overflow-hidden shadow sm:rounded-lg">
        <div style="padding: 1.2rem;">
            <div class="items-center">
                <form wire:submit.prevent="render" action="{{ route('register') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field()}}
                {{method_field('post')}}
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        <x-jet-input wire:model.lazy="name" value="{{ old('name') }}" id="name" name="name" style="width: 370px; height: 36px;" type="text" placeholder="例）山田太郎" autofocus autocomplete="name" />
