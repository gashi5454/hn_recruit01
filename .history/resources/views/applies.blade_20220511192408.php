            ...
            <div class="items-center">
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->name }}" id="name" name="name" style="width: 350px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @else
                        <x-jet-input id="name" name="name" style="width: 350px; height: 36px;" type="text" placeholder="例）山田太郎" />
                        @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana }}" id="kana" name="kana" style="width: 350px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @else
                        <x-jet-input id="kana" name="kana" style="width: 350px; height: 36px;" type="text" placeholder="例）やまだたろう" />
                        @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->name_bands }}" id="name_bands" name="name_bands" style="width: 350px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @else
                        <x-jet-input id="name_bands" name="name_bands" style="width: 350px; height: 36px;" type="text" placeholder="例）山田太郎band" />
                        @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->kana_bands }}" id="kana_bands" name="kana_bands" style="width: 350px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @else
                        <x-jet-input id="kana_bands" name="kana_bands" style="width: 350px; height: 36px;" type="text" placeholder="例）ヤマダタロウバンド" />
                        @endauth
                ...
                <div class="applies-table">
                    ...
                    <div class="applies-table-data">
                        @auth
                        <x-jet-input value="{{ Auth::user()->email }}" id="email" name="email" style="width: 350px; height: 36px;" type="email" />
                        @else
                        <x-jet-input id="email" name="email" style="width: 350px; height: 36px;" type="email" />
                        @endauth
