        ...
        <div class="p-6">
            <div class="items-center">
                ...
                <div class="composition-table">
                    <div class="composition-table-title font-medium text-sm text-gray-700">代表者氏名</div>
                    <div class="composition-table-title font-medium text-sm text-gray-700" style="color: #FF0000;">(必須)</div>
