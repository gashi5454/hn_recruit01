        ...
        <div class="p-6">
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-5 ml-2 flex items-center justify-between">
                        <div>ボーカル</div>
                    ...
                    <div class="mt-5 ml-2 block items-center justify-between">
                        <div>その他</div>
                        <x-jet-input id="other_contact" class="block mt-1 w-full" style="height: 30px;" type="text" name="com_other" />
                    </div>
