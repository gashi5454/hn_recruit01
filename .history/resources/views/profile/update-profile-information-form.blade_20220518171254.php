<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="kana" type="kana" class="mt-1 block w-full" wire:model.defer="state.kana" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="name_bands" type="name_bands" class="mt-1 block w-full" wire:model.defer="state.name_bands" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="kana_bands" type="kana_bands" class="mt-1 block w-full" wire:model.defer="state.kana_bands" />
