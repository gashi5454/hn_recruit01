<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-0 min:mx-0 sm:mx-8 md:mx-8 lg:mx-8 my-16">プロフィール情報</div>
        <!-- Profile Photo -->
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
        <div x-data="{photoName: null, photoPreview: null}" class="mt-6 xs:mx-0 min:mx-0 sm:mx-8 md:mx-8 lg:mx-8">
        ...
        <!-- 代表者氏名 -->
        <div class="mt-6 xs:mx-0 min:mx-0 sm:mx-8 md:mx-8 lg:mx-8">
        ...
        <div class="flex justify-center bg-gray-500 text-white text-base xs:mx-0 min:mx-0 sm:mx-8 md:mx-8 lg:mx-8 my-16">バンド/ユニット情報</div>
        ...
        <div class="bands-info mx-auto xs:max-w-280 min:max-w-280 sm:max-w-450 md:max-w-450 lg:max-w-520">
            ...
            <div class="mt-16 xs:mx-0 min:mx-0 sm:mx-8 md:mx-8 lg:mx-8">
