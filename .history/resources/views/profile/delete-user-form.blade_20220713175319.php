<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-2 mb-4 flex items-center justify-center xs:text-xs min:text-xs sm:text-sm md:text-sm lg:text-sm text-gray-600">
            保存しておきたいデータなどは削除前にダウンロードしてください。
        </div>
