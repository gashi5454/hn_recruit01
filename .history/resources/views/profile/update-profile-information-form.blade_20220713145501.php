<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="bands-info mx-auto xs:max-w-280 min:max-w-280 sm:max-w-450 md:max-w-450 lg:max-w-520">
            ...
            <div id="instIsOpen"><x-jet-input value="{{ old('vo_inst_other') }}" id="vo_inst_other" wire:model.defer="state.vo_inst_other" class="my-1 w-full xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base" type="text" /></div>
