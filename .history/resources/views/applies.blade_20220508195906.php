            ...
            <div class="flex items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-3 flex items-center">
                        ...
                        <select id="vo_num" class="block ml-6 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 80px; height: 36px;" name="vo_num">
