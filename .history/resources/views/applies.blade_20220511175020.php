        ...
        <div class="p-6">
            <div class="items-center">
                ...
                {{method_field('post')}}
                    ...
                    <div class="mt-4 mx-8 flex items-center justify-start">
                        <div>
                            <div class="mr-1 font-medium text-sm text-gray-700">ジャンル</div>
                        </div>
                        <select id="genre" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" style="width: 50%; height: 40px;" name="genre">
                            @auth
                    ...
                    <div class="mt-8 mx-8 flex items-center justify-start">
                        <div>
                    ...
                    <div class="mt-8 mx-8 flex items-center justify-start">
                        <div>
                            <div class="mr-1 font-medium text-sm text-gray-700">備考</div>
                        </div>
                        @auth
                        <x-jet-input value="{{ Auth::user()->remarks }}" id="remarks" name="remarks" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @else
                        <x-jet-input id="remarks" name="remarks" class="ml-2" style="width: 65%; height: 36px;" type="text" />
                        @endauth
                    </div>
