    ...
    <div class="max-w-7xl mt-10 py-10 mx-auto sm:px-6 lg:px-8">
        <div class="mt-8 bg-white border-01">
            ...
            <div class="p-2 line-break items-center">
                ...
                <div class="flex justify-start mt-6 w-full xs:mx-2 min:mx-2 sm:mx-12 md:mx-12 lg:mx-16 xs:text-sm min:text-sm sm:text-base md:text-base lg:text-base">
                    <x-jet-label class="border bg-gray-500" style="width:30%" for="name" value="{{ __('代表者氏名') }}" />
                    <div class="border bg-white" style="width:70%">
                    @isset($applies['name'])
