...
//応募メール送信
//Route::post('/mail_offers', [MailSendController::class, 'mail_offers'])->name('mail_offers');
//Route::get('/mail_offers', [MailSendController::class, 'mail_offers'])->name('mail_offers');
Route::post('/mail_offers', [AppliesController::class, 'store'])->name('mail_offers');
Route::get('/mail_offers', [AppliesController::class, 'store'])->name('mail_offers');
