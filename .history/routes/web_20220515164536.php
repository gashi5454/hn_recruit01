...
//応募メール送信
Route::post('/send_completed', [MailSendController::class, 'send_applies_forUser'])->name('send_completed');
Route::get('/send_completed', [MailSendController::class, 'send_applies_forUser'])->name('send_completed');
