...
Route::get('/mail_offers', [MailController::class, 'mail_offers'])->name('mail_offers');
Route::get('/send_completed', [MailController::class, 'send_completed'])->name('send_completed');
