...
//応募メール送信
//Route::post('/send_applies', [MailSendController::class, 'send_applies'])->name('send_applies');
//Route::get('/send_applies', [MailSendController::class, 'send_applies'])->name('send_applies');
